...
<body style="margin-top:10px;" id="page-top">
  <!-- Page Wrapper -->
  <div style="border-top:1px solid #2B1B23;border-bottom:1px solid #2B1B23;" id="wrapper">

    <!-- Sidebar -->
    <ul style="background-color:#4B273C;" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">

      <!-- Sidebar - Brand -->
      <a style="text-decoration:none;color:white;padding:16px;font-size:16px;" class=" d-flex align-items-center justify-content-center" href="my dashboard.php">
        <div class="sidebar-brand-icon">
          <i class="fa fa-video-camera" style="font-size:20px;" aria-hidden="true"></i>
        </div>
        <div class=" mx-4">My Videos</div>
      </a>
      ...
      <!-- Heading -->
      <div style="font-size:12px;"  class="sidebar-heading">
        Videos
      </div>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Video Grid &nbsp; <i class="fa fa-th" aria-hidden="true"></i></a>
            <a class="collapse-item" href="cards.html">Recent Uploads &nbsp; <i class="fa fa-history" aria-hidden="true"></i></a>
             <a class="collapse-item" href="cards.html">List Video &nbsp; <i class="fas fa-list"></i></a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Main Content -->
      <div id="content" style="background-color:#2A1A22;">
